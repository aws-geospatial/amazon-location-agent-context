...
ADDRESS_VERIFICATION_HEADER_WHEN=$(cat <<'EOF'
Validate addresses input from users before taking actions or persisting to databases
EOF
)

ADDRESS_VERIFICATION_CONTENT=$(cat <<'EOF'
