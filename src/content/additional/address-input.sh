...
ADDRESS_INPUT_HEADER_WHEN=$(cat <<'EOF'
Create effective address input forms for users with address type ahead completion improving input speed and accuracy
EOF
)

ADDRESS_INPUT_CONTENT=$(cat <<'EOF'
# Address Input
